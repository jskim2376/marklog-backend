...
public class JwtOAuth2LoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		ResponseCookie responseCookie = ResponseCookie.from("refresh_token", refresh_token).path("/api")
				.sameSite("strict").httpOnly(true).secure(true).maxAge((int) (jwt.getRefreshtoken_expired() / 1000))
				.build();
