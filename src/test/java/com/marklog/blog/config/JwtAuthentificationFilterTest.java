...
import com.marklog.blog.config.auth.JwtAuthentificationFilter;
...
public class JwtAuthentificationFilterTest {
	...
	public void testJwtAuthentificationFilter() throws ServletException, IOException {
		...
		//when
		JwtAuthentificationFilter jwtAuthentificationFilter = new JwtAuthentificationFilter(jwtTokenProvider, userService);
