...
import com.marklog.blog.config.auth.JwtOAuth2LoginSuccessHandler;
...
public class JwtOauthLoginSuccessHandlerTest {
	...
	public void testJwtOauthLoginSuccessHandler() throws IOException, ServletException {
		//given
		JwtOAuth2LoginSuccessHandler jwtOauthLoginSuccessHandlerTest = new JwtOAuth2LoginSuccessHandler(jwtTokenProvider);
